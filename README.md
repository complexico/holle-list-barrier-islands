...
- The digitisation for $`\textcolor{crimson}{\textsf{Mentawai}}`$ (not
  the “1933” one) ([page](http://dx.doi.org/10.25446/oxford.30928769)),
  $`\textcolor{crimson}{\textsf{Nias (1905)}}`$
  ([page](http://dx.doi.org/10.25446/oxford.30978940)),
  $`\textcolor{crimson}{\textsf{Nias (1911)}}`$
  ([page](https://doi.org/10.5281/zenodo.18128741)),
  $`\textcolor{crimson}{\textsf{Salang and Sigule}}`$
  ([page](https://doi.org/10.5281/zenodo.18308216)),
  $`\textcolor{crimson}{\textsf{Sigulei and Salang}}`$
  ([page](https://doi.org/10.5281/zenodo.18437402)), and
  $`\textcolor{crimson}{\textsf{Seumalur (NBG 1912)}}`$
  ([page](http://dx.doi.org/10.25446/oxford.30924731)) was conducted by
  [my
  ...
  to introduce *WeSay* to the students. The outputs of the digitisation
  were manually checked, edited, and fixed (by the first author, GPWR)
  before being published and archived as mentioned in the section below.

#### Updates from students’ contributions
...
- The [Sigulei and Salang (NBG
  1912)](https://github.com/Holle-List/sigule-salang-1912-holle-list)
  list has been published
  ([DOI](https://doi.org/10.5281/zenodo.18437402))

We have finished the manual checking and editing (via Google
Spreadsheet) of students’ digitisation works for the above regional
lists of the Barrier Islands Languages of Sumatra, Indonesia.

The future work is orthography standardisation and CLDF conversion for
the complete set of the Barrier Islands Languages Holle List.
