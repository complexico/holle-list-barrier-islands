...
- Files in the `plaintexts` directory that are (nearly) done are:
    ...
    - (_in-progress_ ⚠) mentawai1933.txt

- The digitisation process for the lists of Mentawai (not the "1933" one), Nias (1905 and 1911), Salang and Sigule, Sigulei and Salang, and Seumalur is being conducted by my students at the English Lexicology and Lexicography course in the Bachelor of English Literature, Faculty of Humanities, Udayana University. This is part of a class project to introduce WeSay app to the students.

    - UPDATE: The digitisation of the above languages via WeSay has been finished. The .sfm files from the WeSay projects are to be further processed (particularly matching the main word list with the notes)
