...
nias1911_tb_out <- nias1911_tb |> 
  select(cats, 2:13, matches("^nt_"), matches("oncept(icon)?_")) |> 
  select(!matches("(tapah|lekon|simalur)"))
nias1911_tb_out
nias1911_tb_out |> write_tsv("data-output/nias1911.tsv")
nias1911_tb_out |> write_tsv("../nias1911-holle-list/raw/nias1911.tsv")
